...
- [ ] H1: Ep2 の Ruka 合流時期修正 + word_count 更新
- [ ] H2: Ep17 タイトル変更 + episodes.md の表示確認
- [ ] H3 or H4: "East" の重複解消（少なくとも一方）
- [ ] H5: Ep37 語数トリミング + word_count 更新
- [ ] H6: timeline.md の Ep97 記述更新
- [ ] M1: Ep15 末尾追記 + word_count 更新
- [ ] M2: Ep19 または Ep20 の story_day 修正
- [ ] M3 or M7: "Three" の重複解消（どちらか一方）
- [ ] M4: Ep48 冒頭にブリッジ文追加
- [ ] M5: Ep51 タイトル変更
- [ ] M6: Ep59 の General Adelie をキャラクターリストに追加
- [ ] M8: Ep76 タイトル変更
- [ ] M9: Ep84 の "a long time ago" 修正
- [ ] M10: Ep92 / Ep94 タイトル変更
