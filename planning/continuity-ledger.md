...
> ⚠️**v2リナンバリング進行中（2026-07-08〜）**：S3の旧Ep番号は `s3-episode-list-v2.md` の各章表で読み替える。**移行済み＝Ch25〜32（v2 Ep201〜271）**。未移行章の旧番号記載は移行時に順次更新。⚠️**命名の確立点（v2追加）**：少年が「Dango」を得る＝v2 Ep219／「Ako-chan」を得る＝**v2 Ep246**（🔒 *"I am Ako-chan," she says, simply. "You can call me Ako-chan."*＝S1 Ep3 "I am Obia." の名乗り文法エコー）。少年の名は最後まで無し（非対称）。
