...
> **v2移行済み（2026-07-08）＝13話（Ep288〜300・新規6話）**：旧294→288／旧295→291／旧296→292／旧297→294／旧298→295／**旧299・旧300は番号も本文も完全無変更**。新規＝289（England歳月）・**290（The Silver One Hears＝ロボットの動物語理解の起源。⚠️二羽はループ・共有歴を語らない——海/光/冬の小さな話のみ＝S1暗号化記憶と整合）**・293（Before the Dawn＝日記を開いたまま置く）・296（Hello, Twice＝要石。二羽だけが両端の立会人）・297（Not Alone）・298（The Old Dog Dreams。⚠️Dangoの死は描かない）。England並走＝氷の歳月と英国の歳月は同時進行。本節の旧Ep番号は上記で読み替え。
...
> ✅**v2リナンバリング完了（2026-07-08）＝全10章・全100話（v2 Ep201〜300）**。本節以降の旧Ep番号は `s3-episode-list-v2.md` の各章表＋各章の「v2移行済み」注記で読み替える。実装記録の正＝`timeline.md` の各章v2ブロック。⚠️**命名の確立点（v2追加）**：少年が「Dango」を得る＝v2 Ep219／「Ako-chan」を得る＝**v2 Ep246**（🔒 *"I am Ako-chan," she says, simply. "You can call me Ako-chan."*＝S1 Ep3 "I am Obia." の名乗り文法エコー）。少年の名は最後まで無し（非対称）。
