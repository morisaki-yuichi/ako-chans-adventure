...
## Chapter 29「Building Alone」— ロボット制作・単独（Ep232〜240・9話・★v2改稿済み）

**Ch29 共通（v2再設計 2026-07-08 改稿反映）**
- ★v2＝11話→**9話**：旧241→232／旧242+243→**233統合**／旧244→234／旧245→235／旧246→**236改稿（方針7）**／旧247→**237（★方針7アンカー①維持）**／旧248+250→**238統合（方針7・少年ミラー減量）**／旧249→**239改稿（方針7＋動物前兆＋Kara-san軽口）**／旧251→240。
- ★v1決定を全継承：温室＝中立な二人の場所／作りかけ＝少年POVで中立語（robot/Obia/名前/Pod不使用）／Ako-chan POVは物理特徴可（silver/small/pale blue eyes・未点灯）／無意識の牽引のみ・因果接続しない／少年発話ゼロ（初発話=Ch30）／第二の動機は形にしない／🔒 *"Here is wrong."*／テクノバブル回避。
- ★**方針7の適用（本章が最多）**：
  - **237＝アンカー①維持**：*"She does not know how she knows."*（装置の確立・唯一の許可点）。
  - **236**：④の "does not know why she stopped / cannot say what / does not understand" 3連を所作へ＝"Her feet stopped before any thought came. The half-made shape holds her where she is."。
  - **239**：免責3文（"She does not say the memory out loud." 等）と迂言2種を削除→**物理トークンのみ**（"A silver shape moves through her mind. A pair of pale blue eyes, long gone."）＋所作（"She looks at the shape, then at her own hands. Then she passes the boy the next part."／"The shape holds her, and she lets it."）。「he does not notice/does not know what she half-remembers」も削除。
  - **238**：少年ミラー5文→1文（"Few names for feelings live in him."＝性格描写として残置）。
- ★**239の新規ビート**：動物の前兆（Suke-sanの耳が立つ・Daluが止まる＝Ch31認識への低い伏線）＋**Kara-san軽口**＝🔒 "A silver egg," ... "Strange nest, you two."（軽レジスター・方針5）。
- Day割付（v2）：**Day49〜64**＝232(49)・233(50)・234(54)・235(56)・236(58)・237(58)・238(59＝旧248+250を同日昼→夜に圧縮)・239(60)・240(64)。季節＝晩冬→早春の兆し（v1継承）。

### 各話（v2）
- **Ep232「He Begins」**（旧241・本文無変更）：D49。着手・秘密。wc290。
- **Ep233「Hard to Say Why」**（旧242+243統合）：D50。動機の不定形＋難航＋失敗の中の平静。"The reason can stay hidden, for now."。wc287。
- **Ep234「Parts and Failures」**（旧244・本文無変更）：D54。失敗の山→最初の小さな動き。wc279。
- **Ep235「Alone at Night」**（旧245・本文無変更）：D56。初めて「ひとり」が寂しい。wc270。
- **Ep236「Through the Doorway」**（旧246改稿・方針7）：D58。発見。④所作変換済み。wc276。
- **Ep237「Here Is Wrong」**（旧247・本文無変更・★アンカー①）：D58。🔒 *"Here is wrong."*／*"She does not know how she knows."* 維持。wc278。
- **Ep238「Without a Word」**（旧248+250統合・方針7）：D59。修理（昼）→雨の夜の内省。"Here is wrong," she said, so sure.（エコー維持）。wc297。
- **Ep239「The Shape」**（旧249改稿・方針7＋前兆＋軽口）：D60。読者だけが繋ぐ核。🔒Kara-san "A silver egg," ... "Strange nest, you two."。wc277。
- **Ep240「Again Tomorrow」**（旧251・本文無変更・章クローザー）：D64。一人→二人へ。next_ep=/season3/chapter30/ep241/（Ch30移行時に実体化）。wc276。

<!-- Ch29 v2改稿完了（2026-07-08）：9話・旧241-251削除・word_count実測反映・リンク連鎖確認。次＝Ch30（v2 Ep241〜251・命名イベントEp246含む）。 -->
