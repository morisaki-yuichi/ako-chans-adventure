...
## Chapter 33「The Ones Who Remember」— 南極・洞窟・対話劇（Ep272〜287・16話・★v2改稿済み）

**Ch33 共通（v2再設計 2026-07-08 改稿反映）**
- ★v2＝11話→**16話**：旧283→272／旧284→273／旧285→274（長文1分割）／旧286→275／旧287→276／旧288→**277 Unheard**／**278=The Two Old Soldiers（新規＝パイロットC統合）**／旧289→279／**280=A Crow Asks（新規・England間奏①）**／旧290→281／旧291→**282改稿（Pen-san's Vigil＝🔒台詞は逐語維持・本文はvigil史を厚く再構成）**／旧292→283（無変更＝**完全な沈黙が主題のため「一言追加」案は撤回**）／**284=What the Silver One Learns（新規・再演の反転）**／**285=The Empty Bench（新規・England間奏②）**／**286=The White Wind（新規・動レジスター・嵐）**／旧293→287。
- ★**順序の時系列修正**：v2リストの277/278は**入れ替え**て実装（Unheard=到着日の昼→Two Old Soldiers=当夜。パイロットC冒頭 "All day, neither of them has spoken." が昼の277を前提とするため）。承認済みの内容・両話の存在は不変。
- ★**Ch33=声のある章（ペンギン対話劇）**：278 🔒（"You saw it too." "I saw it." … "It is the friend." "It does not know us." "Not yet." … "We stay." "We watch." "Yes. Like before."）／284 🔒（General "It does not understand us." / Pen-san "It follows," "That is enough, for now."）／286 🔒（Pen-san "We have done this before." / General "...Yes. For the friend."）。ロボット呼称＝it／the friend（名前不使用）。**少年には一切届かない**＝劇的アイロニー維持。
- ★**England間奏×2**：280＝Kara-san "Where is the quiet one, then?" ＋"He took the silver egg?"（Ep239口癖回収）＋**日記④**（開いて・書けず・名前を一度だけ読む＝ladder進行。名前は印字しない）。285＝**LucaのPodが少年の空きベンチへ**（Ep215-216の冬の接近の再演）＋Ako-chan "She misses him,"＋④「公園にも空席ができた」＝Ep204（庭の空席）との対句。
- ★**284=再演の反転**：かつて嵐へ独り出て皆を守った silver shape を、今度は二羽が先導して守る（"The care goes back the other way now."）。silver oneが二羽を**見つめ始める**＝Ep290（v2）の「聴く」獲得への布石。
- ★**286=嵐（動）**：一晩で収束・死傷なし。二羽が少年とsilver oneを庇導。④＝少年が寝床を二羽の近くへ移す（行動のみ・不知の断定なし）。⚠️grey不使用（少年POV外）。
- ★v1決定を全継承：タイムマシン未存在（着手まで）／S2機械の因果は回収しない／二羽の認識は誰にも受け取られない（278で「二羽の間」だけに言葉が生まれる＝方針4の範囲内）／"Antarctica"明示最小／少年POV=中立語。⚠️Pen-sanヒナ回想の「grey down」→「soft down」（grey=少年POV専用の徹底）。
- Day割付（v2）：**Day110〜120**＝272(110)・273〜278(112)・279(113)・280〜283(114)・284(116)・285(117)・286(118)・287(120)。

<!-- Ch33 v2改稿完了（2026-07-08）：16話（新規5）・旧283-293削除・word_count実測反映・リンク連鎖確認。⚠️タイムマシン未存在ガード維持。次＝Ch34（v2 Ep288〜300・13話・最終章）。 -->
