...
## Chapter 31「Blue-White Light」— ロボット完成/起動（Ep252〜261・10話・★v2改稿済み）

**Ch31 共通（v2再設計 2026-07-08 改稿反映）**
- ★v2＝10話（数は不変・-11リナンバー）：旧263→252／旧264→253／旧265→254／旧266→**255拡張（評議④＝声の亀裂）**／旧267→**256（＋日記コーダ③・方針7ミラー減量）**／旧268→257／旧269→**258（方針7所作変換）**／旧270→259／旧271→**260改稿（灰色ノート回収）**／旧272→261。Dayは旧値を継承（89×5・90・91・92・94・96）。
- ★**評議④（Ep255）**：無言の認識の中に**一往復だけ声が漏れる**＝🔒 Gabu *"It is him."*／Suke-san *"It cannot be," ... "It is too young."*→「名前は出ない・残りは音にできない」（畏れの沈黙は維持）。**Ako-chanが聴いたかは確定しない**＝*"If the small words reach her, she gives no sign."*（方針7の曖昧性原則・行動のみ）。方針7＝"She does not know what it means."削除。
- ★**日記コーダ③（Ep256末）**：揺れの夜、日記帳を「開かずに、でも今夜は少し長く持つ」（203→251→**256**→300の背骨）。旧267④の少年ミラー2文→1文（"he cannot name"のみ残置）。
- ★**方針7（Ep258）**："But she says nothing. She lets the memory rest where it lies."→所作（"She lets out one slow breath. Then she reaches over and straightens a tool on the table."）。
- ★**負の動機の回収（Ep260）**：旧271の二つの理由に**灰色ノートの紙の証拠**を接続＝ノートを中央で開く（左＝人間の記録の古いページ／右＝図面の新しいページ）＝"Two kinds of lines, from one hand."（Ep209/228/231の伏線回収・断罪と直接言わない哀歌トーンは旧271を継承）。
- ★v1決定を全継承：起動＝因果語抑制／認識は名を口にしない／Ako-chanのaffect頂点＝揺れ（意識的認識なし）／負の動機の語彙ガード（"extinct"不使用）／南極を明示しすぎない（"far away, and cold, and to the south"）。
- Day割付（v2）：**Day89〜96**＝252-256(89＝起動の日)・257(90)・258(91)・259(92)・260(94)・261(96)。季節＝春。

### 各話（v2）
- **Ep252「It Wakes」**（旧263・本文無変更）：D89。起動。wc283。
- **Ep253「Blue-White Eyes」**（旧264・本文無変更）：D89。「作ったものに見られる」。wc280。
- **Ep254「They Gather」**（旧265・本文無変更）：D89。動物たちが既知のものに寄るように集まる。wc277。
- **Ep255「Recognition」**（旧266拡張・評議④）：D89。声の亀裂→畏れの沈黙。wc303。
- **Ep256「Held Back」**（旧267改稿）：D89。赤が一瞬揺れる＋日記コーダ③。wc311。
- **Ep257「The Red Wavered」**（旧268・本文無変更）：D90。「この作品には彼女の秘密がある」。wc271。
- **Ep258「Attachment」**（旧269改稿・方針7）：D91。愛着×S1救出の二重露光。wc293。
- **Ep259「The First Time」**（旧270・本文無変更）：D92。「もう戻れない・戻りたくない」。wc288。
- **Ep260「Two Reasons」**（旧271改稿）：D94。二つの動機＋灰色ノートの見開き。wc303。
- **Ep261「What Is Needed」**（旧272・本文無変更・章クローザー）：D96。時を越える手段・南へ・告げない別れの準備。next_ep=/season3/chapter32/ep262/（Ch32移行時に実体化）。wc293。

<!-- Ch31 v2改稿完了（2026-07-08）：10話・旧263-272削除・word_count実測反映・リンク連鎖確認。次＝Ch32（v2 Ep262〜271）。 -->

---

## Chapter 32「The Parting」— 別れ・赤い首輪（Ep262〜271・10話・★v2改稿済み）

**Ch32 共通（v2再設計 2026-07-08 改稿反映）**
- ★v2＝10話（数は不変・-11リナンバー）：旧273→**262（＋評議⑤決着）**／旧274→263／旧275→264／旧276→265／旧277→**266（方針7密集解消）**／旧278→**267（★方針7アンカー②維持・④集約）**／旧279→268（「聞かない」の集約先＝無変更）／旧280→**269（方針7所作変換）**／旧281→270／旧282→271。Dayは旧値継承（97・98×9）。
- ★**評議⑤決着（Ep262）**：🔒 Dalu "Do we tell her?" "What we think it is?"／Gabu **"She knows more than we do," ... "Her hands knew."**／Suke-san＝無言でAko-chanの側へ（動物たちは**言わないことを選ぶ**＝評議①212→②227→③243→④255→⑤262の完結）。声はPod間で低く＝Ako-chanの目は少年に（聴取は確定しない）。
- ★**方針7＝Ch32密集の解消**：「説明しない・聞かない」の明示は**268（No Reason Asked）に集約**。266＝"No one says where it came from. No one says who made it, or when." 削除→所作（親指が赤い帯をなでる）。267＝アンカー②（*"She has no clear memory of such a moment, and yet her hands are certain."*）のみ残し、④の "He does not know what it means. He does not ask." を削除（268が担う）＋**Kara-san無言のカメオ**（"High in the bare tree, Kara-san watches, and for once says nothing."）。269＝"She does not know its name."／"She does not know why she kept it"／④の "She cannot say why…"×2 を所作へ（palm を collar に当て・立って膝を払う）。270は据置（無言＝主題そのもの）。
- ★v1決定を全継承：首輪の起源は伏せる（bootstrap・Ep184の同一物・"作った"と書かない）／Suke-san🔒 "Go. We will remember."／Dango引用なし（一歩下がる＝最大の贈り物）／Luca＝Podを降りて足元（プーリア回収）／行き先は"白い大陸"poetic（"Antarctica"明示しない）／grey=少年POV専用。
- Day割付（v2）：**Day97〜98**＝262(97)・263〜271(98＝別れの朝)。季節＝春。

### 各話（v2）
- **Ep262「The Day Comes」**（旧273改稿・評議⑤）：D97。旅立ちの告知（🔒少年 "I am going away," "I am taking it with me."）＋動物たちの決着。wc305。
- **Ep263「Luca Holds On」**（旧274・本文無変更）：D98。wc271。
- **Ep264「Suke-san's Last Look」**（旧275・本文無変更）：D98。🔒 "Go," ... "We will remember."。wc284。
- **Ep265「Dango Steps Back」**（旧276・本文無変更）：D98。一歩下がる。wc270。
- **Ep266「Something Red」**（旧277改稿）：D98。首輪の登場・メタ標示を所作へ。wc270。
- **Ep267「The Red Collar」**（旧278改稿・★アンカー②）：D98。無言の装着（沈黙免除）。wc277。
- **Ep268「No Reason Asked」**（旧279・本文無変更・集約先）：D98。wc273。
- **Ep269「The Same Red」**（旧280改稿・方針7）：D98。S1装着×Ep184受領の二重回想・所作で閉じる。wc278。
- **Ep270「No Words」**（旧281・本文無変更）：D98。wc276。
- **Ep271「They Leave」**（旧282・本文無変更・章クローザー）：D98。南へ。next_ep=/season3/chapter33/ep272/（Ch33移行時に実体化）。wc275。

<!-- Ch32 v2改稿完了（2026-07-08）：10話・旧273-282削除・word_count実測反映・リンク連鎖確認。⚠️首輪＝起源を伏せる（Ep184の同一物・bootstrapループ）。次＝Ch33（v2 Ep272〜287・16話・ペンギン対話劇）。 -->
