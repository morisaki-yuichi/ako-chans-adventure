...
### M3 エピソードグリッド（全話設計）— 次の作業
- [ ] 各季 episode-list v2（タイトル・役割・🔒台詞・**義務列**・状態デルタ列つき）→ **S1=✅（Ep1〜98）**／**S2=✅（Ep99〜190）**／**S3=作成済み（Ep191〜277・レビュー待ち）**
- [ ] 話数確定 → 通し番号確定（S1=98✅ → S2=Ep99〜190／S3=Ep191〜277 見込み）
- [ ] 台帳（知識・命名／配置／数・量／状態・義務）をグリッドから生成
- [ ] Dango「取っておき」台詞スロット確定（1〜3箇所）
